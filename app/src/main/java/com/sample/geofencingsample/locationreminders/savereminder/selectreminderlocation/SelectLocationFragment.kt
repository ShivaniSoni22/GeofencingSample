package com.sample.geofencingsample.locationreminders.savereminder.selectreminderlocation
...
import com.sample.geofencingsample.databinding.FragmentSelectLocationBinding
import com.sample.geofencingsample.locationreminders.savereminder.SaveReminderViewModel
...
//        DONE: call this function after the user confirms on the selected location
    ...
    private fun requestQPermission() {
        val hasForegroundPermission = ActivityCompat.checkSelfPermission(requireActivity(),
            Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED
        if (hasForegroundPermission) {
            val hasBackgroundPermission = ActivityCompat.checkSelfPermission(requireActivity(),
