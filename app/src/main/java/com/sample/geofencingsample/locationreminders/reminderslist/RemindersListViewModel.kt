...
import com.sample.geofencingsample.base.BaseViewModel
...
class RemindersListViewModel(
     ...
     */
    fun loadReminders(): MutableLiveData<List<ReminderDataItem>> {
    ...
    fun deleteReminder(itemId: String) {
        viewModelScope.launch {
            //interacting with the dataSource has to be through a coroutine
            dataSource.deleteReminder(itemId)
        }
    }
